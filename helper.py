...
def medal_tally(df):
    ...
    medal_tally['Bribze'] = medal_tally['Bronze'].astype(int)
...
def participating_nations_over_time(df):
    ...
    nation_over_time.columns = ['Year', 'Number_of_countries_participating']
...
def most_successful(df,sport):
    ...
    x.columns = ['Name of player', 'Medals']
    x.merge(df,left_on = 'Name of player',right_on = 'Name',how = 'left')[['Name','Medals','Sport','region']].drop_duplicates('Name')
    return x
...
def most_successful_player_countrywise(df,country):
    temp_df = df.dropna(subset = ['Medal'])
